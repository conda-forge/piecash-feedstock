...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/piecash-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11522&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/piecash-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `piecash` can be installed with:

```
conda install piecash
```

It is possible to list all of the versions of `piecash` available on your platform with:
